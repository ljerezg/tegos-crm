...
export default function AdministradoresFinca({ perfil }) {
  ...
  function filtered() {
    const data = rows.filter(r => {
      ...
      const matchSearch = [r.nombre, r.email, r.email_2, r.telefono, r.movil, r.municipio, r.provincia, r.cod_postal, r.calle, r.numero, r.piso, r.observaciones].join(' ').toLowerCase().includes(q)
